...
## 실제 측정 사례
2026-09-16 Unity 에디터에서 144칸·55청크를 대상으로 측정한 한 사례입니다.

| 작업 | 측정값 |
|---|---:|
| 첫 생성·저장·에디터 처리 | 26.192초 |
| 같은 결과 재사용 배치 | 1.821초 |
| 두 번째 새로 생성한 청크 | 0 / 55 |

재사용 전후 메시와 텍스처 내용 및 에셋 참조의 동일성을 검사했습니다.
이 수치는 해당 시험 환경의 에디터 작업 시간으로, 게임 로딩 시간이나 GPU 프레임 성능을 의미하지 않습니다.
